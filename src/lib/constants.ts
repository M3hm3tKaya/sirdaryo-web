...
export const NAV_LINKS: NavLink[] = [
  { label: "Ana Sayfa", href: "/" },
  {
    ...
    href: "/cozumler",
    children: [
      { label: "RPA ve Otomasyon", href: "/cozumler/rpa", color: "violet" },
      { label: "Low-Code BPM", href: "/cozumler/low-code-bpm", color: "orange" },
      { label: "Optimizasyon", href: "/cozumler/optimizasyon", color: "lime" },
      { label: "Yönetim Paneli", href: "/cozumler/yonetim-paneli", color: "amber" },
      { label: "Özel Yazılım", href: "/cozumler/ozel-yazilim", color: "coral" },
    ],
  },

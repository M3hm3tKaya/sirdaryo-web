      ...
      <Container className="relative z-10">
        <div className="grid items-center gap-12 lg:grid-cols-[55%_45%] lg:gap-16">
          <div>
            ...
            <div className="lc-cta mt-8 flex flex-wrap gap-4">
          ...
          <div className="lc-logo-hero flex items-center justify-center">
            <div className="relative rounded-3xl border border-[#F97316]/15 bg-[#1A130A] p-10 shadow-[0_0_80px_rgba(249,115,22,0.08)]">
              <img
